...
namespace MessageBoard.Migrations
{
    public class CommentsController : Controller
    {
        ...
        {
            var messageBoardContext = _context.Comment.Include(c => c.Topic);
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,CreatedDate,UpdatedDate,TopicId")] Comment comment, int? replyTopicId)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,CreatedDate,UpdatedDate,TopicId")] Comment comment, bool? returnToTopic)
        {
            if (id != comment.Id)
            {
                return NotFound();
